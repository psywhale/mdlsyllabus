...
function block_employees_html_pluginfile($course, $birecord_or_cm, $context, $filearea, $args, $forcedownload) {
    global $SCRIPT;
 ...
 * @return void
 */
function block_employees_html_global_db_replace($search, $replace) {
    global $DB;
