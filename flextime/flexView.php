...
echo '<style language="stylesheet">html { font-family: Verdana; background: #dcd0a0; #width: 700px; #margin: 0 auto;}table.tech tbody tr:nth-child(odd) { background-color: #E0D3A8; }table.tech tbody tr:nth-child(even) { background-color: #EADCAD; } ';
...
echo 'div#round {background-color: #dcd0a0; padding-left:10px;padding-right: 10px;padding-bottom: 10px; width: 420px; -moz-border-radius:10px; -webkit-border-radius:10px; border-radius:10px; border: 1px solid black;}';
...
//
//
/* echo '<p><em style="float: right;"> MUST be signed in <br />to your WOSC E-mail.</em></p>
...
<p><iframe id="white" src="http://docs.google.com/a/newmoodle.wosc.edu/spreadsheet/embeddedform?formkey=dFE0Wjg3d2FUTDFPYUJvdDhVZGRJNXc6MQ" frameborder="0" marginwidth="0" marginheight="0" width="705" height="640"></iframe></p>

<p><em><em></em>Bookmark this form on your phone!</em><a title="URL for your Mobile device" href="http://goo.gl/gRyQ2" target="_blank"><img id="white" style="margin-right: 10px; margin-left: 10px; float: left;" title="Flex Time Link to Form (MUST BE SIGNED IN TO YOUR EMAIL ON YOUR PHONES BROWSER))" src="http://chart.googleapis.com/chart?cht=qr&amp;chs=100x100&amp;choe=UTF-8&amp;chld=H%7C0&amp;chl=http://goo.gl/gRyQ2" alt="flex qr code" width="150" height="150" /></a></p>

<p><strong><br /></strong></p>

<p><strong>MUST be signed in to your WOSC Email on your phones browser.</strong></p>
...
<table style="width: 100%;" border="0" cellspacing="15" cellpadding="15" align="center">
...
//echo '<td style="text-align: left;padding:10px 12px 8px 5px;">TIME USED</td>';
...
//Time Used
//echo '<td style="text-align: left;padding: 2px 2px 0px 10px;" valign="bottom">Coming Soon!</td>';
//DATE FLEX WAS USED
