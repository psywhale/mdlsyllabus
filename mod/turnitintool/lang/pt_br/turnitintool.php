...
$string['maxcommenterror']='Este comentário é muito longo ({$a->caracteres reais}). Máximo de caracteres permitidos {$a->permitido}.';
...
<li><p><b>Partes Nomeadas</b></p>
<p>Essa configuração permite que você defina um nome da parte e o número de correções atribuídas a cada parte do trabalho. Também permite que você defina individualmente as datas de início, de entrega e de publicação para cada parte do trabalho.</p></li>
<li><p><b>Portfolio</b></p>
<p>Essa configuração permite que você agrupe as partes do trabalho em um trabalho. A cada parte é atribuída automaticamente as datas de início, de entrega e de publicação do trabalho geral padrão. As partes não são nomeadas e os usuários enviam um determinado número de envios. A nota geral para o trabalho é calculada usando uma média de notas dadas para cada envio.</p></li>
</ul>';
...
$string['studentstatus']='Enviado {$a->alterado} (Identificação do documento: {$a->objectid})';
...
<ul>
<li><p><b>Upload do Arquivo</b><br />
Você pode fazer o upload do seguintes tipos de arquivos para o <i>Upload de Arquivo</i> tipo de envios: doc, docx, pdf, rtf, txt e html. Ao fazer o upload de um arquivo PDF você deve garantir que o conteúdo do texto é selecionável ao contrário de texto documentos representados por e/ou imagem.</p></li>
<li><p><b>Envio de Texto</b><br />
Você deve utilizar o <i>Envio de Texto</i> para copiar e colar o conteúdo do texto no Turnitin.</p></li>
</ul>';
...
<li><p><b>Upload do Arquivo</b><p>
<p>Permite ao usuário fazer o upload de arquivo dos seguintes tipos:</p>
<ul>
<li>Microsoft Word (doc,docx,rtf,html)</li>
<li>PDF (pdf)</li>
<li>Texto Simples (txt)</li>
</ul></li>
<li><p><b>Envio de Texto</b></p>
<p>Permite ao usuário copiar e colar texto simples dentro da área de texto para fazer o upload para o Turnitin.</p></li>
</ul>';
...
$string['updatestudent']='Atualizando Envio {$a->de} ou {$a->para}';
$string['updatinggrade']='Recuperando Nota Turnitin';
$string['updatingreport']='Recuperando Pontos do Relatório Turnitin';
$string['updatingscores']='Recuperando Dados para {$a->usuário} / Parte do Trabalho {$a->proc}';
...
$string['wrongaccountid']='Ocorreu um erro ao ligar a sua Aula Turnitin. A conta que você configurou está {$a->atual}. A conta dessa aula é de é {$a->backupid}. Você só pode restaurar as aulas que foram originadas na mesma conta do Turnitin.';
$string['yes']='Sim';
