...
$string['maxcommenterror']='Dieser Kommentar ist zu lang ({$a->actual characters}). Maximale Zeichenmenge {$a->allowed}.';
...
$string['maxlength']='$string[\'maxlength\']=\'Die maximale Länge für {$a->field} beträgt {$a->length} Zeichen.';
...
<li><p><b>Benannte Teile</b></p>
<p>Diese Voreinstellung legt den Namen des Teils sowie die Anzahl an entsprechenden Markierungen zu jeder Aufgabe fest. Sie ermöglicht außerdem Start-, Fälligkeits- und Veröffentlichungsdatum individuell festzulegen.</p></li>
<li><p><b>Portfolio</b></p>
<p>Mit dieser Einstellung lassen sich die Aufgabenteile in einer Aufgabe zusammenfassen. Jeder Teil erhält standardmäßig das übergreifende Start-, Fälligkeits- und Veröffentlichungsdatum. Die Teile sind nicht benannt und Benutzer übermitteln eine bestimmte Anzahl an Einreichungen. Die Gesamtnote für die Aufgabe wird als Durchschnittswert anhand der Noten der jeweiligen Einreichungen errechnet.</p></li>
</ul>';
...
<ul>
<li><p><b>Dateiupload</b><br />
Sie können die folgenden Dateitypen <i>Dateiupload</i> zu den Einreichungstypen hochladen: doc, docx, pdf, rtf, txt und html. Wenn Sie eine PDF-Datei hochladen, stellen Sie sicher, dass deren Inhalt im Unterschied zu Textteilen des Dokuments, die als Bild dargestellt sind, auswählbar ist. p></li>
<li><p><b>Texteinreichung</b><br />
Sie können zum Kopieren und Einfügen von Text bei Turnitin die Option <i>Texteinreichung</i> verwenden.</p></li>
</ul>';
...
<li><p><b>Dateiupload</b></p>
</p>Gestattet Benutzern, Dateien folgender Typen hochzuladen:</p>
<ul>
<li>Microsoft Word (doc, docx, rtf, html)</li>
<li>PDF (pdf)</li>
<li>Plain-Text (txt)</li>
</ul></li>
<li><p><b>Texteinreichung</b></p>
<p>Gestattet Benutzern, Plain-Text zu kopieren und zum Hochladen zu Turnitin in das Textfeld einzufügen.</p></li>
</ul>';
