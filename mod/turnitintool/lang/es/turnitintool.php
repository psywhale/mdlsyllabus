...
$string['deleteconfirm']='¿Está seguro que desea eliminar esta entrega? Esta acción no es reversible.';
...
$string['displaygradesas_help']='Esta opción establece el modo de mostrar las notas, las opciones son desplegadas como porcentaje o fracción, por ejemplo 45/60';
...
<li><p><b>Partes Nombradas</b></p>
<p>Esta configuración le permite establecer un nombre para la parte y el número de anotaciones permitidas para cada parte del ejercicio. También le permite establecer individualmente las fechas de inicio, de entrega y de publicación para cada parte del ejercicio.</p></li>
<li><p><b>Portafolio</b></p>
<p>Esta configuración le permite agrupar las partes del ejercicio en un solo ejercicio. Se asignan automáticamente las fechas de inicio, de entrega y de publicación generales para cada parte. Las partes no son nombradas y los estudiantes entregan un número determinado de trabajos. La nota general del ejercicio se calcula usando el promedio de las notas asignadas para cada entrega.</p></li>
</ul>';
...
<ul>
<li><p><b>Carga de archivo</b><br />
Usted puede cargar los siguientes tipos de archivos a la  <i>Carga de archivos</i> tipo de archivo: doc, docx, pdf, rtf, textoy html. Cuando carga un archivo PDF tiene que asegurarse que el texto contenido puede ser seleccionado, a diferencia del texto de un archivo representado por una imagen </p></li>
<li><p><b>Entrega de Texto</b><br />
Puede usar la <i>Entrega de Texto</i>para copiar y pegar el contenido del texto a Turnitin.</p></li>
</ul>';
...
<li><p><b>Carga de archivos</b></p>
<p>Permite al usuario cargar archivos de formato:</p>
<ul>
<li>Microsoft Word (doc,docx,rtf,html)</li>
<li>PDF (pdf)</li>
<li>Texto sin formato (txt)</li>
</ul></li>
<li><p><b>Entrega de texto</b></p>
<p>Permite al usuario copiar y pegar texto sin formato al cuadro de texto para cargarlo a Turnitin.</p></li>
</ul>';
