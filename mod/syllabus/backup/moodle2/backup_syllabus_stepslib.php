...
class backup_syllabus_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $syllabus = new backup_nested_element('syllabus', array('id'), array('name', 'intro', 'introformat', 'timemodified', 'selected_course_syllabus'));
        ...
        $syllabus->annotate_files('mod_syllabus', 'intro', null); // This file area hasn't itemid
