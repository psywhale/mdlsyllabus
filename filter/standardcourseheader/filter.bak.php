...
class filter_standardcourseheader extends moodle_text_filter {
	...
	global $COURSE, $DB;  
		...
		if($url != ''){
			$vid = '<iframe style="max-width: 320px;" wmode="Opaque" src="'.$url.'" title="YouTube video player" frameborder="0" height="212" width="100%"></iframe>';
		}
		else{
...
<p style="text-align: center;"><br /><span><br /></span><small><span><big><span><span size="3"><span style="text-decoration: underline;"><span style="font-size: medium;" size="4"><b>Welcome to '.$courseTitle.'</b></span></span></span><br /></span></big></span></small><span style="font-size: small;"></span></p>
'.$COURSE->summary.'
