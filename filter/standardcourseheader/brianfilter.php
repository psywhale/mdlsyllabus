...
class filter_standardcourseheader extends moodle_text_filter {
	...
	global $COURSE, $DB;  
		...
		foreach($working as $pair) {
			if(preg_match('/\=/i',$pair){
			$keyValues = explode('=',$pair);
			echo "Key = $keyValues[0] and Value = $keyValues[1]";
			}
			/*
			if(preg_match('/video=/',$pair){
				$vidInfo = explode('=',$pair);
				$vid =  '<iframe style="max-width: 320px;" wmode="Opaque" src="http://www.youttube.com/embed/
					'.$vidInfo[1].'?rel=0" title="YouTube video player" frameborder="0" height="212" width="100%"></iframe>'
			}
			elseif(preg_match('/syllabus=/',$pair){
				$syllabusInfo = explode('=',$pair);
				$syllabusLink = 'http://moodle.wosc.edu/mod/page/view.php?id='.$syllabusInfo[1];
			}
		*/
		}
		...
		$block = '
			...
			<tbody>
			<tr>
			<td style="height: 200px; width: 347px;"><br /><center><!-- *********************INSERT VIDEO/PICTURE HERE*********************** -->'.$vid.'<br /><br />
			<table style="width: 95%;" border="0">
			<tbody>
			<tr>
			<td style="text-align: center;">
			<p style="text-align: center;"><span style="color: #ff0000;"><span style="color: #000000;">Instructor - 
			'.$instInfo->firstname.' '.$instInfo->lastname.'</span><br />Phone - 
			'.$instInfo->phone1.'<br />E-mail - 
			'.$instInfo->email.'
			</span><br />Western Oklahoma State College is on <span style="font-weight: bold;">Central Standard Time</span></p>
			<span style="font-weight: bold; font-size: x-large;" class="Apple-style-span" size="5">Please Complete:</span>
			<br style="font-weight: bold;" />
			<a style="font-weight: bold;" title="Feedback" 
			href="https://docs.google.com/a/newmoodle.wosc.edu/spreadsheet/viewform?hl=en_US&amp;formkey=dDBnTEt4ejNrMEFiQXNzSEpCeVZ5UkE6MQ#gid=0" target="_blank">Intersession Feedback Form</a></td>
			</tr>
			</tbody>
			</table>
			<!-- *********************END VIDEO/PICTURE HERE*********************** --></center></td>
			<td style="height: 200px; width: 313px; text-align: center;">
			<p style="text-align: center;"><br /><span><br /></span><small><span><big><span><span size="3">
			<span style="text-decoration: underline;"><span style="font-size: medium;" size="4"><b>Welcome to 
			'.$courseTitle.'</b></span></span></span><br /></span></big></span></small><span style="font-size: small;"></span></p>
			'.$COURSE->summary.'
			<p><b><span style="text-decoration: underline;"><br /></span></b></p>
			<p><br /><!-- End Extra Course Info -->i
			<!-- ***************************** start 1st steps ********************** --></p>
			<div id="ststeps"><small><big><br /><br /><br /></big></small><small><big></big></small><ol>
			<li style="text-align: left;"><small><big><a title="Syllabus" 
			href="http://moodle.wosc.edu/mod/page/view.php?id=27511" target="_blank">
			<span class="nolink">Syllabus</span></a><a title="Syllabus" href="'.$syllabusLink.'"></a></big></small></li>
			...
			<tbody>
			<tr>
			<td valign="top" width="100%"><span class="Apple-style-span"><small><big><span></span>
			<!-- ***************************** Course Resources ********************** --><span style="font-weight: bold;"></span></big></small></span>
			<blockquote style="margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 40px; border-style: none; padding: 0px;" class="webkit-indent-blockquote">
			<small><small><big><span></span></big><big><span><big><span style="font-weight: bold;">Common Resources</span><br /></big></span></big></small></small>
			<ul>
			...
			<!-- ***************************** End Technical Help ********************** -->
			<!-- ***************************** Common Resources ********************** --><span style="font-weight: bold;"></span>
			<!-- ***************************** End Common Resources ********************** --></td>
			</tr>
			</tbody>
			</table>
			<center></center></td>
